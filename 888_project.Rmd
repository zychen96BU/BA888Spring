...
# data preparation
f1<-as.formula(paste(names(prediction_dataset)[10], paste(names(prediction_dataset)[-10], collapse=" + "), sep=" ~ "))
...
# xnames <- xnames[!xnames %in% c("train", "Econ","year","ISO_code","countries","rank")]
